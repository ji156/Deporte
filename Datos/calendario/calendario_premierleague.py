...
class CalendarioCrawler(CrawlSpider):
    ...
    rules = (
        ...
        Rule(
            ...
            ), follow=True, callback='parse_premierleague'
        ),
    )
    ...
    def clear_database(self):
        ...
        tables_to_clear = ["calendario_premierleague"]
    ...
    def parse_premierleague(self, response):
    ...
    def save_to_database(self, item):
        ...
        api_url = "http://localhost:8000/calendario/api/calendario/premierleague/"

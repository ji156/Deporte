...
class CalendarioCrawler(CrawlSpider):
    ...
    rules = (
        ...
        Rule(
            ...
            ), follow=True, callback='parse_laliga_femenina'
        ),
    )
    ...
    def clear_database(self):
        ...
        tables_to_clear = ["calendario_laliga_femenina"]
    ...
    def parse_laliga_femenina(self, response):
    ...
    def save_to_database(self, item):
        ...
        api_url = "http://localhost:8000/calendario/api/calendario/laligafemenina/"
